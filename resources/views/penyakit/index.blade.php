                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-8 form-group">
                                                                                <input type="text" class="form-control"
                                                                                    name="code" value="A{{$code + 1}}" disabled>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <center>
                                                                ...
                                                                <div class="modal fade text-left" id="success{{$list->id}}" tabindex="-1"
                                                                    ...
                                                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <form method="post" action="{{url('/penyakit/'.$list->id)}}">
                                                                                @csrf
                                                                                @method('patch')
                                                                                <div class="modal-body">
                                                                                    <div class="form-body">
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-md-8 form-group">
                                                                                                <input type="txet" class="form-control"
                                                                                                    name="penyakit" value="{{$list->penyakit}}">
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                ...
                                                                <div>
                                                                    <form action="{{url('/penyakit/'.$list->id)}}" method="post">
                                                                    @method('delete') @csrf

                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-8 form-group">
                                                                                <input type="text" class="form-control"
                                                                                    name="code" value="A<?php echo e($code + 1); ?>" disabled>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                            ...
                                                                            <div class="col-md-8 form-group">
                                                                                <input type="txet" class="form-control"
                                                                                    name="penyakit" placeholder="Input here...">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                            </div>
                                            ...
                                            <table class="table table-striped" id="table1">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo e($list->penyakit); ?></td>
                                                        <td>
                                                            <center>
                                                                ...
                                                                <div class="modal fade text-left" id="success<?php echo e($list->id); ?>" tabindex="-1"
                                                                    ...
                                                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <form method="post" action="<?php echo e(url('/penyakit/'.$list->id)); ?>">
                                                                                <?php echo csrf_field(); ?>
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    <div class="form-body">
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-md-8 form-group">
                                                                                                <input type="txet" class="form-control"
                                                                                                    name="penyakit" value="<?php echo e($list->penyakit); ?>">
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                ...
                                                                <div>
                                                                    <form action="<?php echo e(url('/penyakit/'.$list->id)); ?>" method="post">
...
<?php echo $__env->make('layouts/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\daun\resources\views/penyakit/index.blade.php ENDPATH**/ ?>
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Login SPK Pendeteksi Penyakit Tanaman Padi</h2>
				</div>
			</div>
			<div class="row justify-content-center">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fajri\resources\views/auth/login.blade.php ENDPATH**/ ?>